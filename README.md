...
def color(num:int, picture:str):
    ...
    match choice:
        ...
        case 3:
            ...
            return c
```
For assigning a color to the text in the python console, we used the [ANSI escape codes](httphttps://en.wikipedia.org/wiki/ANSI_escape_code#cite_note-CruzGianone1997-31:// "ANSI escape codes").
